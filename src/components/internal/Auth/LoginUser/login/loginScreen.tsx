      ...
      <div className="w-full max-w-sm bg-white rounded-3xl shadow-xl p-8 sm:p-10 flex flex-col items-center">
        ...
        {!termsAccepted ? (
          <button
            ...
            className="w-full h-12 bg-white hover:bg-gray-50 text-gray-700 rounded-full border border-gray-200 flex items-center justify-center gap-3 font-medium text-sm font-['Poppins'] transition-all"
          >
