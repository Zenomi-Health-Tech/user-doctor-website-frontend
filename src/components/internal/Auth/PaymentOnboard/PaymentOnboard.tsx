    ...
    return (
      <div className="min-h-screen w-full flex flex-col items-center justify-center relative font-['Poppins'] bg-gradient-to-b from-[#8B2D6C] to-[#C6426E] overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center w-full px-4">
          ...
          {/* Pay Button */}
          <button className="w-full max-w-md py-4 rounded-full bg-gradient-to-r from-[#FFD966] to-[#EAC96B] text-[#8B2D6C] font-semibold text-xl shadow hover:opacity-90 transition mb-4">Pay &amp; Continue</button>
          {/* Footer */}
