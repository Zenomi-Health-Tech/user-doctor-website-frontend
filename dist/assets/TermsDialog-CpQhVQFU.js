import{R as w,r as i,j as e,P,h as m,i as o,k as T,X as N,T as p,D as u,O as f}from"./index-ByFIazGl.js";const D=w,j=P,h=i.forwardRef(({className:t,...s},a)=>e.jsx(f,{ref:a,className:o("fixed inset-0 z-50 bg-black/80  data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",t),...s}));h.displayName=f.displayName;const g=i.forwardRef(({className:t,children:s,...a},n)=>e.jsxs(j,{children:[e.jsx(h,{}),e.jsxs(m,{ref:n,className:o("fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border bg-background p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg",t),...a,children:[s,e.jsxs(T,{className:"absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground",children:[e.jsx(N,{className:"h-4 w-4"}),e.jsx("span",{className:"sr-only",children:"Close"})]})]})]}));g.displayName=m.displayName;const y=({className:t,...s})=>e.jsx("div",{className:o("flex flex-col space-y-1.5 text-center sm:text-left",t),...s});y.displayName="DialogHeader";const x=({className:t,...s})=>e.jsx("div",{className:o("flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2",t),...s});x.displayName="DialogFooter";const b=i.forwardRef(({className:t,...s},a)=>e.jsx(p,{ref:a,className:o("text-lg font-semibold leading-none tracking-tight",t),...s}));b.displayName=p.displayName;const v=i.forwardRef(({className:t,...s},a)=>e.jsx(u,{ref:a,className:o("text-sm text-muted-foreground",t),...s}));v.displayName=u.displayName;const C=`1. Introduction
...
10. Acceptance
By using the Zenomi Health Platform, the Doctor acknowledges that they have read, understood, and agreed to these Terms & Conditions.`,k=`1. Nature of Service
...
By using Zenomi, you acknowledge that:
  ...
  • You understand the scope and limitations of the service`;function A({open:t,onAccept:s,onDecline:a,type:n}){const[r,c]=i.useState(!1),l=n==="doctor";return e.jsx(D,{open:t,onOpenChange:d=>{d||a()},children:e.jsxs(g,{className:"max-w-lg max-h-[85vh] flex flex-col p-0 gap-0 overflow-hidden",children:[e.jsx("div",{className:"px-6 py-5 rounded-t-lg",style:{background:l?"linear-gradient(135deg, #704180, #8B2D6C)":"linear-gradient(135deg, #8B2D6C, #704180)"},children:e.jsxs(y,{children:[e.jsx(b,{className:"text-white text-xl font-['Poppins']",children:"Terms & Conditions"}),e.jsxs(v,{className:"text-white/70 font-['Poppins']",children:["Zenomi Health Platform – ",l?"Doctor":"Patient"]})]})}),e.jsx("div",{className:"flex-1 overflow-y-auto px-6 py-4 text-sm text-gray-700 leading-relaxed whitespace-pre-line font-['Poppins']",children:l?C:k}),e.jsxs("div",{className:"border-t bg-gray-50 px-6 py-4 rounded-b-lg",children:[e.jsxs("label",{className:"flex items-start gap-3 cursor-pointer mb-4",onClick:()=>c(!r),children:[e.jsx("input",{type:"checkbox",checked:r,onChange:d=>c(d.target.checked),className:"mt-0.5 h-4 w-4 rounded border-gray-300 accent-[#704180]"}),e.jsx("span",{className:"text-sm text-gray-700 font-['Poppins']",children:"I have read and agree to the Terms & Conditions"})]}),e.jsxs(x,{className:"flex-row gap-3",children:[e.jsx("button",{onClick:a,className:"flex-1 h-11 rounded-xl border border-[#704180] text-[#704180] font-semibold text-sm font-['Poppins'] hover:bg-[#704180]/5 transition-colors",children:"Decline"}),e.jsx("button",{onClick:s,disabled:!r,className:"flex-1 h-11 rounded-xl bg-[#704180] text-white font-semibold text-sm font-['Poppins'] hover:bg-[#5a3468] transition-colors disabled:opacity-40 disabled:cursor-not-allowed",children:"Accept & Continue"})]})]})]})})}export{A as T};
